...
public partial struct LookTurretJob : IJobEntity
{
    ...
    public void Execute(ref TurretLook l, ref LocalTransform transform, 
        RefRO<LocalToWorld> world, ref Parent parentEntity)
    {
        var t = TargetLookup.GetRefRO(parentEntity.Value);
        ...
        RefRO<LocalToWorld> parentWorld = LocalToWorldLookup.GetRefRO(parentEntity.Value);
